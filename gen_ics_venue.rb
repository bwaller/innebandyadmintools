...
venue_game_length = { 
  "Herrar Div 1 Mellersta Svealand" => Rational(135,minutes_per_day),
  ...
  "DM Herr Slutspel" => Rational(120,minutes_per_day),
  "Herrar Div 1 Östra Svealand" => Rational(135,minutes_per_day),
  "Herrar division 2" => Rational(120,minutes_per_day),
  ...
  "Pantamera Flickor Blå Lätt Lätt Södra" => Rational(60,minutes_per_day),
  "Pantamera Flickor Blå Lätt Svår Södra" => Rational(60,minutes_per_day),
  "Pantamera Flickor Bå Lätt Svår Mellersta" => Rational(60,minutes_per_day),
  ...
  "Pantamera Flickor Blå Medellätt B" => Rational(60,minutes_per_day),
  "Pantamera Flickor Blå Medellätt C" => Rational(60,minutes_per_day),
  "Pantamera Flickor Blå Medel-Svår B" => Rational(60,minutes_per_day),
  "Pantamera F Blå Svår B" => Rational(60,minutes_per_day),
  "Pantamera Flickor Blå Svår" => Rational(60,minutes_per_day),
  ...
  "Pantamera Flickor Röd Medellätt B" => Rational(75,minutes_per_day),
  ...
  "Pantamera Flickor Röd Medelsvår Södra" => Rational(75,minutes_per_day),
  ...
  "Pantamera Pojkar Blå Lätt Lätt C" => Rational(60,minutes_per_day),
  ...
  "Pantamera Pojkar Blå Medel Lätt A" => Rational(60,minutes_per_day),
  ...
  "Pantamera Pojkar Blå Medel Svår Södra" => Rational(60,minutes_per_day),
  ...
  "Pantamera Pojkar Blå Svår Lätt B" => Rational(60,minutes_per_day),
  "Pantamera Pojkar Blå Svår Lätt C" => Rational(60,minutes_per_day),
  "Pantamera Pojkar Blå Svår Lätt E" => Rational(60,minutes_per_day),
  ...
  "Pantamera Pojkar Ljusröd Medelsvår Norra" => Rational(75,minutes_per_day),
